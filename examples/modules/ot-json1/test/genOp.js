...
// 拷贝
const clone = (o) =>
  typeof o === "object" ? JSON.parse(JSON.stringify(o)) : o;
...
module.exports = genRandomOp = (
  doc //文档
) => {
  // 拷贝
  doc = clone(doc);

  // 90% chance of adding an op the first time through, then 50% each successive time. 第一次手术的几率是90%，之后每次手术的几率是50%。
  let chance = 0.99;
