var assert, fuzzer, genTests, nativetype, transformX;
...
transformX = function (type, left, right) {
  return [
...
genTests = function (type) {
  ...
  describe("number", function () {
    ...
    return it("doesn't overwrite values when it merges na in append", function () {
      ...
      (_ref = transformX(type, rightOp, leftOp)),
        (right_ = _ref[0]),
        (left_ = _ref[1]);
  ...
  describe("object", function () {
    ...
    it("replacement vs. replacement", function () {
      var leftHas, leftOps, left_, rightHas, rightOps, right_, _ref;
      assert.deepEqual(
        [],
        type.transform(
          [
      ...
      (_ref = transformX(type, leftOps, rightOps)),
        (left_ = _ref[0]),
        (right_ = _ref[1]);
